# Generated by Django 4.1 on 2022-09-27 20:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='auth.group', verbose_name='user type')),
        ...
        migrations.AddField(
            ...
            name='users',
            field=models.ManyToManyField(related_name='user', through='accounts.LaboratoryUsers', to=settings.AUTH_USER_MODEL),
        ),
    ]
