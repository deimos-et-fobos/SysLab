...
from .serializers import UserSerializer, LaboratorySerializer, LaboratoryUsersSerializer
...
class LaboratoryUsersView(generics.ListAPIView):
    queryset = LaboratoryUsers.objects.all()
    serializer_class = LaboratoryUsersSerializer
